...
%* Mejores tiempos de respuesta como aporte secundario en la metodología
%* ^esto es complicado de medir debido a que falta información.
...
%* No utilizar el calificativo mejor, si no estoy seguro de que es mejor
%* (porque no tengo datos ara hacer back a esa parte) de manera oportuna el mantenimiento preventivo y correctivo
...
%* Una mejor documentación por consecuencia*
...
%* Esta parte se escucha ambiciosa, sobre todo porque necesito evidencia para justficarlo.
...
%* Los alcances tienen que ser en pasado.
