...
Si bien los datos que se recolectan en el sistema serán puestos a disposición al público por la forma en la que el LCCA funciona actualmente, es decir, un servicio publico financiado para que los alumnos de la universidad tengan acceso a datos propios para realizar investigaciones locales, el acceso al control de las estaciones meteorológicas puede significar un vector de ataque a los sistemas de la universidad que dependen de ellos.

Tanto el sistema de backups, como otros.
